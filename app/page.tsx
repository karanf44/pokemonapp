      ...
      <div className="container mx-auto py-8">
        ...
        {error && (
          <div className="text-red-500 text-center mt-4 p-4 bg-red-50 rounded-lg">
            <p className="font-semibold">Error loading Pokemon</p>
        ...
        {initialLoading ? (
          ...
          <div className="text-center mt-8 p-8 bg-gray-50 rounded-lg">
            <p className="text-xl text-gray-600">No Pokemon found</p>
          ...
          <>
            <div className="text-center text-gray-600 mb-4">
              Showing {pokemon.length} of {totalCount} Pokemons
            </div>
        ...
        {loading && !initialLoading && (
          <div className="text-center mt-8 pb-8">
            <LoadingSpinner />
            <p className="text-gray-600 mt-2">Loading more Pokemon...</p>
          </div>
        )}
